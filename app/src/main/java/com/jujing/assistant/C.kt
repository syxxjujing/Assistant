...
object C {
    ...
    val TextView = android.widget.TextView::class.java

    val CharSequence = java.lang.CharSequence::class.java
    ...
    val AlertDialog_Builder = AlertDialog::class.java
}